      ...
      <div class="form">
        ...
        <div class="radio-group" style="grid-column: 1 / span 2;">
          ...
          <label class="radio-item"> <input type="checkbox" name="tipo" value="bife">
            ...
            <span>Strogonoff</span> </label> <label class="radio-item"> <input type="checkbox" name="tipo"
              value="moida">
            <span>Tirinha</span> </label> <label class="radio-item"> <input type="checkbox" name="tipo" value="moida">
            <span>Medalhão</span> </label>
