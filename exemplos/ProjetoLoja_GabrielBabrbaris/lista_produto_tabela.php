...
<html lang="pt-br">
  <head>
    ...
    <title>Lista de Produto Tabela</title>
  </head>
  <body>
    <div class="container">
        <h1>Lista de Produto Tabela</h1>
        ...
        /*2-Criando o comando sql para consulta dos registros */
            $comandoSql="select P.IDPROD, P.NOMEPROD, P.PRECOPROD, C.NOMECATE 
                        ...
                        WHERE C.IDCATE=P.CODCATE ORDER BY IDPROD";
        ...
        /*4-Pegando os dados da consult criada e exibindo */
            while($dados=mysqli_fetch_assoc($resultado)){
                $id=$dados["IDPROD"];
                $nome=$dados["NOMEPROD"];
                $precoprod=$dados["PRECOPROD"];
                $categoria=$dados["NOMECATE"];

                //echo"<br><br>Id: $id";
                //echo"<br>Nome: $nome";
                //echo"<br>Preço do Produto: $precoprod";
                ...
                echo"<tr>
                    ...
                    <td>$categoria</td>
                    <td>
                      <a href='frm_altera_produto.php?id=$id'>
                        <button type='button' class='btn btn-light'>Editar</button>
                      </a>
                    </td>
                    <td>
                      <a href='del_produto.php?id=$id'>
